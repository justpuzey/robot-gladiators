...
var startGame =function(){
  ...
  for (var i = 0; i < enemyNames.length; i++) {
    ...
    if (playerHealth > 0) {
      ...
      //if player is still alive and we're not at the last enemey in the array
      if(playerHealth > 0 && i < enemyNames - 1){
        // ask if player wants to use the store before nextg round
...
var shop = function(){
  ...
  //function to genedrate a random numeric value
